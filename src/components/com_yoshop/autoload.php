...
class YoAutoload
{
    ...
    public static function setup()
    {
        ...
        if (JFactory::getApplication()->isSite()) {
            self::registerPrefix('YoHelper', $site.$ds.'helpers');
            self::registerPrefix('YoModel',  $site.$ds.'models');
        }

        // Register the base path for Joomla platform libraries.
        self::registerPrefix('YoHelper', $admin.$ds.'helpers');
        self::registerPrefix('YoModel',  $admin.$ds.'models');
        self::registerPrefix('YoTable',  $admin.$ds.'tables');
        self::registerPrefix('Yo', $admin.$ds.'classes');

        // Register the autoloader functions.
        spl_autoload_register(array('YoAutoload', '_autoload'));
