...
YoshopHelperHtml::addStylesheet('search/search.css');
...
<div class="page-header">
    <span class="content"><?php echo  JText::sprintf('COM_YOSHOP_SEARCH_RESULTS', $this->searchword); ?></span>
</div>
...
<!--                    <span class="slideshow clickable media-entity" data-url="--><?php //print $product->link; ?><!--"><i class="icon-camera"></i></span>-->
        ...
        <h3 style="text-align:center;display: block;">
            <?php echo JText::_('COM_YOSHOP_SEARCH_IS_EMPTY'); ?>
        </h3>
    <?php } ?>
