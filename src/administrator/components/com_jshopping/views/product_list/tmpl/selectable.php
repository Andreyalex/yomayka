	...
	<?php
	 ...
	 ?>
	  <tr class = "row<?php echo $i % 2;?>">
	   ...
	   <td align="center">
		 <?php
		   echo $published = ($row->product_publish) ? ('<img title = "'._JSHOP_PUBLISH.'" border="0" alt="" src="components/com_jshopping/images/tick.png">') : ('<img title = "'._JSHOP_UNPUBLISH.'" border="0" alt="" src="components/com_jshopping/images/publish_x.png">');
		 ?>
	   </td>
	   <td align="center">
