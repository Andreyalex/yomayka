...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_yoshop&task=products.saveOrderAjax&tmpl=component';
...
<form action="<?php echo JRoute::_('index.php?option=com_yoshop&view=products'); ?>" method="post" name="adminForm" id="adminForm">
...
<?php endif;?>
		...
		<table class="table table-striped" id="productList">
			<thead>
				...
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_YOSHOP_PRODUCTS_CREATED_BY', 'a.created_by', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_YOSHOP_PRODUCTS_NAME', 'a.name', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_YOSHOP_PRODUCTS_DESCRIPTION', 'a.description', $listDirn, $listOrder); ?>
				</th>
