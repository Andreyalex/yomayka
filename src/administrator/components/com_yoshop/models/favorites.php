 ...
 */
class YoshopModelFavorites extends YoModelList
{
    public $rowClassName = 'YoshopModelFavorite';
    ...
    protected function getListQuery() {
        ...
        $query->from('`#__yoshop_favorite` AS a');
...
//        $query->join('LEFT', '#__users AS uc ON uc.id=a.checked_out');
        ...
        if (!empty($fields)) {
            $query->join('', '#__yoshop_favorite_field as field ON field.favorite_id = a.id');
