...
class YoshopAutoload
{
    ...
    public static function setup()
    {
        ...
        if (JFactory::getApplication()->isSite()) {
            self::registerPrefix('YoshopHelper', $site.$ds.'helpers');
            self::registerPrefix('YoshopModel',  $site.$ds.'models');
        }

        // Register the base path for Joomla platform libraries.
        self::registerPrefix('YoshopHelper', $admin.$ds.'helpers');
        self::registerPrefix('YoshopModel',  $admin.$ds.'models');
        self::registerPrefix('YoshopTable',  $admin.$ds.'tables');
        self::registerPrefix('Yoshop', $admin.$ds.'classes');

        // Register the autoloader functions.
        spl_autoload_register(array('YoshopAutoload', '_autoload'));
