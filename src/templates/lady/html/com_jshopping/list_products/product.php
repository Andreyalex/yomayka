...
<div class = "product <?php echo $productClass; ?>">
  <div class="inner">  
        <?php if ($product->image){?>
            <?php if ($product->label_id){?>
                <?php if ($product->_label_image){?>
                    <a class="image" href="<?php print $product->product_link?>">
