...
<form name = "product" method = "post" action = "<?php print $this->action?>" enctype="multipart/form-data">
    ...
    <!--<h1 class="pane-header"><?php print $this->product->name?><?php if ($this->config->show_product_code){?> <span class="jshop_code_prod">(<?php print _JSHOP_EAN?>: <span id="product_code"><?php print $this->product->getEan();?></span>)</span><?php }?></h1>-->
    ...
    <div class="span5">
        ...
        <div id="product-images-<?php echo $this->product->id; ?>" class="carousel slide">
          <!-- Carousel items -->
          ...
          <!-- Carousel nav -->
          <a class="carousel-control left" href="#product-images-<?php echo $this->product->id; ?>" data-slide="prev">&lsaquo;</a>
          <a class="carousel-control right" href="#product-images-<?php echo $this->product->id; ?>" data-slide="next">&rsaquo;</a>
        </div>
